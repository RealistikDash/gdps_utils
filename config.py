...
from console.logger import info, debug
import os
import json
...
class Config(ConfigReader):
    """The main gdps_utils class for the storage of config values.
    These values are read directly from the `config.json` file."""
    sql_host: str      = "localhost"
    sql_user: str      = "root"
    sql_db: str        = "geometrydash"
    sql_password: str  = ""
    dir_levels: str    = "/var/www/html/database/data/levels"
